...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='AcademicGroup',
            fields=[
                ('academic_group_code', models.IntegerField(primary_key=True, serialize=False, verbose_name='Шифр навчальної групи')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_number', models.CharField(max_length=50, null=True, verbose_name='Номер студентського квитка')),
                ('academic_group_of_student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='expimpmembers.AcademicGroup', verbose_name='Академічна група')),
            ],
            options={
                'db_table': 'Студенти',
            },
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='expimpmembers.Faculty', verbose_name='Факультет'),
        ),
    ]
